...
crime.plot(output=None, year=None, month=None,
           cax_position=[0.75, 0.06, 0.05, 0.76], vmax=1010,
...
crime.plot_obj.fig.suptitle(
    "Average Drug Offences in Kensington\nand Chelsea In September",
    fontsize=20, y=0.97)
...
path = join(get_base_path(__file__), "Output", "Results", "Spatial Temporal",
            "Results_KensingtonAndChelsea_DrugOffences_ChoroplethSeptember.svg")
