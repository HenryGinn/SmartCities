...
data_path = join(
    base_path, "Output", "LSTM", f"Case_1",
    "D0_False__L0_False__L1_32__L2_64__D1_False",
...
ax.set_ylim((-5, 4))
ax.plot([i2, i2], [-4.5, 3.6], color=grey, dashes=(3, 3))
ax.text(I1, 3, "Training", ha="center", fontsize=14)
ax.text(I2, 3, "Validation", ha="center", fontsize=14)

ax.set_xlabel("Date", fontsize=14, labelpad=5)
ax.set_ylabel("Residuals", fontsize=14)
fig.suptitle("Modelling Residual Series\nFor Case 1 Using LSTM", fontsize=20, y=0.97)
...
output_path = join(
    ...
    "ResidualForecast_LSTM_Case_1.pdf")
