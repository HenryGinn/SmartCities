...
nulls_v = 22.610260686255142
nulls_t = 12.173913936193571


results_path = join(base_path, "Output", "SARIMA", f"Case_4")
...
fig.suptitle(f"SARIMA Configurations For Case 4", fontsize=20, y=0.97)

output_path_plot = join(base_path, "Output", "Results", "Forecasting", f"Selection_SARIMA_Case_4.pdf")

plt.savefig(output_path_plot, format="pdf")
