...
data_path = join(
    ...
    "Case_3", "SARIMA", "TimeSeries_validate.csv")
...
plt.fill_between(
    df.index, df[f"ConfLowerOriginal"],
    df[f"ConfUpperOriginal"], color=blue, alpha=0.3)
...
ax.set_ylim((0, 8000))
ax.plot([i2, i2], [400, 7600], color=grey, dashes=(3, 3))
ax.text(I1, 7100, "Training", ha="center", fontsize=14)
ax.text(I2, 7100, "Testing", ha="center", fontsize=14)
