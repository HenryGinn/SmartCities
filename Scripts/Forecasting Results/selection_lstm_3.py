...
nulls_v = 2.429720862049619
nulls_t = 0.5148320194421647


results_path = join(base_path, "Output", "LSTM", f"Case_3")
...
fig.suptitle(f"LSTM Configurations For Case 3", fontsize=20, y=0.97)

output_path_plot = join(base_path, "Output", "Results", "Forecasting", f"Selection_LSTM_Case_3.pdf")
