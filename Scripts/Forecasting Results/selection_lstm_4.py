...
results_path = join(base_path, "Output", "LSTM", f"Case_4")
...
fig.suptitle(f"LSTM Configurations For Case 4", fontsize=20, y=0.97)

output_path_plot = join(base_path, "Output", "Results", "Forecasting", f"Selection_LSTM_Case_4.pdf")
