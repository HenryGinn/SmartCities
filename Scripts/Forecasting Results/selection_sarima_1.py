...
results_path = join(base_path, "Output", "SARIMA", f"Case_1")
...
fig.suptitle(f"SARIMA Configurations For Case 1", fontsize=20, y=0.97)

output_path_plot = join(base_path, "Output", "Results", "Forecasting", f"Selection_SARIMA_Case_1.pdf")
