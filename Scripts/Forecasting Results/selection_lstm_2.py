...
nulls_v = 6.628650253619732
nulls_t = 0.8105473322991597


results_path = join(base_path, "Output", "LSTM", f"Case_2")
...
fig.suptitle(f"LSTM Configurations For Case 2", fontsize=20, y=0.97)

output_path_plot = join(base_path, "Output", "Results", "Forecasting", f"Selection_LSTM_Case_2.pdf")
