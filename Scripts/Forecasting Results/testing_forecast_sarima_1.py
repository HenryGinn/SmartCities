...
ax.set_ylim((0, 2000))
ax.plot([i2, i2], [100, 1900], color=grey, dashes=(3, 3))
ax.text(I1, 1780, "Training", ha="center", fontsize=14)
ax.text(I2, 1780, "Testing", ha="center", fontsize=14)
