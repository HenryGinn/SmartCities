...
data_path = join(
    base_path, "Output", "LSTM", f"Case_2",
    "D0_32__L0_False__L1_False__L2_64__D1_False",
...
ax.plot([i2, i2], [-4.55, 2.65], color=grey, dashes=(3, 3))
ax.text(I1, 2.1, "Training", ha="center", fontsize=14)
ax.text(I2, 2.1, "Validation", ha="center", fontsize=14)

ax.set_xlabel("Date", fontsize=14, labelpad=5)
ax.set_ylabel("Residuals", fontsize=14)
fig.suptitle("Modelling Residual Series\nFor Case 2 Using LSTM", fontsize=20, y=0.97)
...
output_path = join(
    ...
    "ResidualForecast_LSTM_Case_2.pdf")
