...
data_path = join(
    ...
    "Case_4", "Control", "TimeSeries_validate.csv")
...
ax.set_ylim((0, 90000))
ax.plot([i2, i2], [4000, 86000], color=grey, dashes=(3, 3))
ax.text(I1, 80000, "Training", ha="center", fontsize=14)
ax.text(I2, 80000, "Testing", ha="center", fontsize=14)

ax.set_xlabel("Date", fontsize=14, labelpad=5)
ax.set_ylabel("Crimes Per 100,000 People", fontsize=14, labelpad=22)

fig.suptitle("Forecasting Crime Count For\nCase 4 Using Control Model",
             fontsize=20, y=0.97)
